...
describe("Import Verification", () => {
  ...
  describe("Core Functionality", () => {
    ...
    test("should import advanced generator class (direct import)", async () => {
      ...
      expect(advancedGeneratorModule).toHaveProperty(
        "AdvancedTrainingPlanGenerator",
      );
      expect(typeof advancedGeneratorModule.AdvancedTrainingPlanGenerator).toBe(
        "function",
      );
  ...
  describe("Type Safety", () => {
    test("should verify currently available type imports work correctly", async () => {
      ...
      const config: typeof indexModule.TrainingPlanConfig =
    ...
    test("should verify excluded types work via direct import", async () => {
      ...
      const config: typeof advancedModule.AdvancedPlanConfig =
