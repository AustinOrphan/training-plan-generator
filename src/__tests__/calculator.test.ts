...
describe('Calculator Module', () => {
  ...
  describe('Training Load Calculations', () => {
    ...
    it('should provide appropriate recommendations based on ratio', () => {
      ...
      for (let week = 0; week < 4; week++) {
        for (let day = 0; day < 5; day++) {
          recentRuns.push(createMockRunData(-(week * 7 + day), {
      ...
      expect(['increasing', 'stable', 'decreasing']).toContain(trainingLoad.trend);
    });
    ...
    it('should detect overtraining risk', () => {
      ...
      for (let i = 0; i < 7; i++) {
        highLoadRuns.push(createMockRunData(-i, {
  ...
  describe('Injury Risk Calculations', () => {
    it('should calculate injury risk with correct 3-parameter signature', () => {
      ...
      const risk = calculateInjuryRisk(trainingLoad, weeklyIncrease, recoveryScore);
  ...
  describe('Weekly Pattern Analysis', () => {
    it('should analyze weekly training patterns', () => {
      ...
      expect(patterns.maxWeeklyMileage).toBeGreaterThanOrEqual(patterns.avgWeeklyMileage);
    ...
    it('should identify optimal training days', () => {
      ...
      for (let week = 0; week < 6; week++) {
        // Tuesday runs
        consistentRuns.push(createMockRunData(0, {
    ...
    it('should calculate consistency score accurately', () => {
      ...
      expect(perfectPatterns.consistencyScore).toBeGreaterThanOrEqual(inconsistentPatterns.consistencyScore);
    });
  });
  ...
  describe('Comprehensive Fitness Metrics', () => {
    ...
    it('should integrate all calculator functions correctly', () => {
      ...
      expect(metrics.lactateThreshold).toBe(calculateLactateThreshold(metrics.vdot));
  ...
  describe('Edge Cases and Error Handling', () => {
    ...
    it('should handle single run data', () => {
      const singleRun = [createMockRunData(-1, {
        distance: 10,
        duration: 50,
        avgPace: 5.0,
        effortLevel: 7
