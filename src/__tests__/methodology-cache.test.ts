...
describe("Methodology Cache System", () => {
  ...
  describe("Pace Calculation Caching", () => {
    it("should cache pace calculations for methodologies", () => {
      ...
      const result1 = calculateMethodologyPacesCached(
        methodology,
        vdot,
        phase,
        weekNumber,
      ...
      const result2 = calculateMethodologyPacesCached(
        methodology,
        vdot,
        phase,
        weekNumber,
    ...
    it("should cache different methodology/phase combinations separately", () => {
      ...
      const danielsResult = calculateMethodologyPacesCached(
        "daniels",
        vdot,
        "build",
        weekNumber,
      ...
      const lydiardResult = calculateMethodologyPacesCached(
        "lydiard",
        vdot,
        "build",
        weekNumber,
  ...
  describe("Workout Selection Caching", () => {
    it("should cache workout selection results", () => {
      ...
      // First call
      const result1 = selectWorkoutCached(
        methodology,
        phase,
        weekNumber,
        dayOfWeek,
      ...
      // Second call should use cache
      const result2 = selectWorkoutCached(
        methodology,
        phase,
        weekNumber,
        dayOfWeek,
    ...
    it("should cache different fitness levels separately", () => {
      ...
      const fitness1: FitnessAssessment = {
        vdot: 40,
        weeklyMileage: 30,
        recentRaces: [],
        fitnessLevel: "fair",
      };
      const fitness2: FitnessAssessment = {
        vdot: 50,
        weeklyMileage: 60,
        recentRaces: [],
      ...
      const cached1 = selectWorkoutCached(
        methodology,
        phase,
        weekNumber,
        dayOfWeek,
      ...
      const cached2 = selectWorkoutCached(
        methodology,
        phase,
        weekNumber,
        dayOfWeek,
  ...
  describe("Philosophy Comparison Caching", () => {
    it("should cache philosophy comparisons", () => {
      ...
      // First call
      const result1 = comparePhilosophiesCached(
        methodology1,
        methodology2,
        undefined,
        comparator,
      ...
      // Second call should use cache
      const result2 = comparePhilosophiesCached(
        methodology1,
        methodology2,
        undefined,
        comparator,
      ...
      const result3 = comparePhilosophiesCached(
        methodology2,
        methodology1,
        undefined,
        comparator,
  ...
  describe("Cache Management", () => {
    it("should provide cache statistics", () => {
      ...
      calculateMethodologyPacesCached("daniels", 45, "build", 1, () => ({
        easy: 450,
      }));
    ...
    it("should provide optimization recommendations", () => {
      const recommendations =
        MethodologyCacheManager.getOptimizationRecommendations();
  ...
  describe("Cache Warming", () => {
    it("should warm pace calculation caches", async () => {
      ...
      await MethodologyCacheWarmer.warmPaceCalculations(
        methodologies,
        vdotRange,
        calculator,
      );
