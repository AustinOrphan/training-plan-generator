 ...
 */
export function hasIntensityConfig(
  config: unknown,
): config is { intensity: MethodologyConfig["intensity"] } {
  return (
 ...
 * Uses proper type narrowing instead of 'as any' casting
 */
export function hasVolumeConfig(
  config: unknown,
): config is { volume: MethodologyConfig["volume"] } {
  return (
    typeof config === "object" &&
    config !== null &&
    "volume" in config &&
 ...
 * Uses proper type narrowing instead of 'as any' casting
 */
export function hasRecoveryConfig(
  config: unknown,
): config is { recovery: MethodologyConfig["recovery"] } {
  return (
    typeof config === "object" &&
    config !== null &&
    "recovery" in config &&
...
export function getIntensityConfig(
  config: unknown,
): MethodologyConfig["intensity"] | undefined {
...
export function getVolumeConfig(
  config: unknown,
): MethodologyConfig["volume"] | undefined {
...
export function getRecoveryConfig(
  config: unknown,
): MethodologyConfig["recovery"] | undefined {
 ...
 * Uses proper type narrowing instead of 'as any' casting
 */
export function isTestableGenerator(
  generator: unknown,
): generator is TestableTrainingPlanGenerator {
  return (
    typeof generator === "object" &&
    generator !== null &&
    "generateMicrocycles" in generator &&
    typeof (generator as Record<string, unknown>).generateMicrocycles ===
      "function"
  );
}
 ...
 */
export type MethodologyScores = Record<
  TrainingMethodology,
